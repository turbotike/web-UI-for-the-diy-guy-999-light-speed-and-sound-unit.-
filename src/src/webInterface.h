        ...
        {                         // if there's bytes to read from the client,
          ...
          { // if the byte is a newline character
            ...
            if (currentLine.length() == 0)
            {
              ...
              client.println(".slider{-webkit-appearance:none;appearance:none;width:95%;height:22px;background:rgba(8,16,6,.85);outline:none;border:2px solid #3f9f24;margin:6px auto;border-radius:999px;touch-action:pan-y;}");

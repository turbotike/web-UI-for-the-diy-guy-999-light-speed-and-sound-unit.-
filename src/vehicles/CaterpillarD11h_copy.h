...
#include "sounds/JakeBrakeDummy.h" // silent placeholder (disabled)
#endif
...
volatile int dieselKnockVolumePercentage = 0; // Adjust the Diesel knock volume (usually = 200 - 600%) 200
...
#define TRACK_DRIVE_CUSTOM // this vehicle declares its own track-drive tuning below

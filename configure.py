...
FRIENDLY_NAMES = {
    ...
    "SURVONAUTS": "Survonauts Shift-Gate (park, flick to engage)",
    ...
    "combinedRearLights": "Combined Rear Lights (US)",
...
FRIENDLY_DESCRIPTIONS = {
    ...
    "combinedRearLights": "One rear lamp per side = tail + turn + brake (US pickup/trailer style).",
    ...
    "combinedRearLights": "US style: each rear lamp is tail (half), turn signal (flashes) and brake (full).",

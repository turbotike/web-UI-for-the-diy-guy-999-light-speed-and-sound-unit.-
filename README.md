...
# RC Engine Sound ESP32 — Configurator Edition

### by **turbotike**

*A powerful web-based configurator for the ESP32 RC engine sound & light controller*

**Original firmware by [TheDIYGuy999](https://github.com/TheDIYGuy999/Rc_Engine_Sound_ESP32)** — this fork adds a full browser-based GUI for tuning sounds, lights, ESC, and more — no code editing required.
...
| Feature | Description |
|---------|-------------|
| **One-Click Configurator** | `START.bat` — double-click, browser opens, done |
| **Web UI** | Full browser-based settings editor — sliders, dropdowns, checkboxes |
| **Live Sound Builder** | Load any engine sound, preview it live, adjust loop points, crossfade, smoothing, RPM simulation — all in the browser |
| **WAV → Header Converter** | Drag-and-drop .wav files, convert to ESP32-compatible .h headers with resampling & normalization |
| **Sound Library** | Browse & preview all included engine sounds, install with one click |
| **Volume Control** | Software volume slider (0-250%) with pot override option |
| **Compile & Flash** | Build and upload firmware directly from the web UI (requires Arduino CLI) |
| **Backup & Restore** | Export/import your full vehicle configuration |
| **Validation** | Automatic checking and fixing of vehicle config files |
...
### 1. Download
```
git clone https://github.com/turbotike/Rc_Engine_Sound_ESP32.git
```
Or download the ZIP and extract it.

### 2. Launch
**Windows:** Double-click **`START.bat`**
- If Python isn't installed, it will offer to install it automatically
- Your browser opens to the configurator
...
### 3. Configure
- Adjust engine sounds, lights, ESC, transmission, and more
- Use the **Live Sound Builder** to create and preview custom engine sounds
- Hit **Compile & Flash** to upload to your ESP32
...
### Truck Setup
The main config screen lets you tweak every parameter with sliders and checkboxes — no more editing `.h` files by hand.

### Live Sound Builder
Load any engine sound, set loop points, adjust crossfade and smoothing, preview at different RPMs in real-time, then install with one click.

### WAV Converter
Drag & drop .wav files to convert them to ESP32-compatible .h sound headers.

---

## Hardware

This works with the **TheDIYGuy999 ESP32 Sound & Light Controller** board (v1.2 or compatible):

- **ESP32-WROOM-32** (240MHz, must be 30-pin)
- **PAM8403** amplifier module
- 4-8 ohm speakers
- Standard RC receiver (PWM, PPM, SBUS, or IBUS)

For hardware details, schematics, and PCB ordering: see the [original project](https://github.com/TheDIYGuy999/Rc_Engine_Sound_ESP32).
...
## Vehicle Sounds Included

Over **80+ vehicle sound profiles** are included out of the box:

| Category | Examples |
|----------|----------|
| **Diesel Trucks** | Scania V8, Mack SuperLiner, Kenworth W900A, MAN TGX, Mercedes Actros |
| **Gas Trucks** | Chevy 468, GMC Sierra |
| **Muscle Cars** | 1965 Ford Mustang V8, Chevy Nova Coupe, Jaguar XJS |
| **Crawlers** | Land Rover Defender (V8, Td5), Jeep Wrangler Rubicon, Land Cruiser FJ40 |
| **Heavy Equipment** | Caterpillar D6/D11, Hitachi ZW370, CAT 730, Komatsu |
| **Military** | GAZ-66, M35, IS-3 Tank, Kirovets K700 |
| **Tractors** | Ferguson TEA20, Unimog, Ural |
| **Motorcycles** | Harley Davidson FXSB |
| **Supercars** | LaFerrari, Jeep Trackhawk |
...
├── configure.py           ← Web configurator server (zero dependencies)
├── src/
│   ├── src.ino            ← Main firmware
│   ├── 0_generalSettings.h ... 10_Trailer.h  ← Config files
│   └── vehicles/          ← 80+ vehicle sound profiles
├── tools/
│   ├── Audio2Header.html  ← Browser-based WAV converter (original)
│   └── Header2Audio.html  ← Reverse converter
├── hardware/              ← Eagle schematic & PCB files
└── documentation/         ← Changelog, pictures
```
...
| | |
|---|---|
| **Configurator & Enhancements** | **turbotike** |
| **Original Firmware** | [TheDIYGuy999](https://github.com/TheDIYGuy999) |
| **Halloween Sound Base** | [bitluni](https://github.com/bitluni) |
| **LCD Dashboard** | Frevic, Gamadril |

---

## License

This project builds on the open-source [Rc_Engine_Sound_ESP32](https://github.com/TheDIYGuy999/Rc_Engine_Sound_ESP32) by TheDIYGuy999. The web configurator additions are by turbotike.
